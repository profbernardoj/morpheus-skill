...
> AI agent for daily briefings and news

## Overview

Briefing Claw is a flavor of the [EverClaw](https://everclaw.xyz) decentralized AI agent ecosystem, powered by Morpheus Network inference.

**Domain:** briefingclaw.com  
**Default Model:** GLM-5 (via Morpheus decentralized inference)

## What This Flavor Does

This flavor provides the common Morpheus infrastructure (wallet, proxy, session management, security) with a persona and configuration tailored for: AI agent for daily briefings and news.

## Installation

```bash
curl -sSL https://briefingclaw.com/install.sh | bash
```

Or clone and set up manually:

```bash
git clone https://github.com/profbernardoj/briefingclaw.com.git
cd briefingclaw.com
npm install
