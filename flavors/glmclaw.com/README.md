...
> AI agent powered by GLM models

## Overview

GLM Claw is a flavor of the [EverClaw](https://everclaw.xyz) decentralized AI agent ecosystem, powered by Morpheus Network inference.
...
This flavor provides the common Morpheus infrastructure (wallet, proxy, session management, security) with a persona and configuration tailored for: AI agent powered by GLM models.

## Installation

```bash
curl -sSL https://glmclaw.com/install.sh | bash
```

Or clone and set up manually:

```bash
git clone https://github.com/profbernardoj/glmclaw.com.git
cd glmclaw.com
npm install
