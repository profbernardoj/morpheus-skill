...
> AI agent for Ethereum ecosystem

## Overview

Ethereum Claw is a flavor of the [EverClaw](https://everclaw.xyz) decentralized AI agent ecosystem, powered by Morpheus Network inference.

**Domain:** ethereumclaw.com  
**Default Model:** GLM-5 (via Morpheus decentralized inference)

## What This Flavor Does

This flavor provides the common Morpheus infrastructure (wallet, proxy, session management, security) with a persona and configuration tailored for: AI agent for Ethereum ecosystem.

## Installation

```bash
curl -sSL https://ethereumclaw.com/install.sh | bash
```

Or clone and set up manually:

```bash
git clone https://github.com/profbernardoj/ethereumclaw.com.git
cd ethereumclaw.com
npm install
