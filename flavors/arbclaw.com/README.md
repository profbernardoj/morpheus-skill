...
> AI agent for Arbitrum ecosystem

## Overview

Arb Claw is a flavor of the [EverClaw](https://everclaw.xyz) decentralized AI agent ecosystem, powered by Morpheus Network inference.
...
This flavor provides the common Morpheus infrastructure (wallet, proxy, session management, security) with a persona and configuration tailored for: AI agent for Arbitrum ecosystem.

## Installation

```bash
curl -sSL https://arbclaw.com/install.sh | bash
```

Or clone and set up manually:

```bash
git clone https://github.com/profbernardoj/arbclaw.com.git
cd arbclaw.com
npm install
